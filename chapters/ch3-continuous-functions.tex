...
\begin{example}[Concluding convergence from continuity]
  ...
  \answergraph{graphs/sequence-continuity.pdf}
...
\begin{example}[Concluding continuity from convergence]
